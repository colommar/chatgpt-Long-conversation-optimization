...
const I18N_MESSAGES = {
  en: {
    ...
    "toolbar.subtitle": "Long threads · Search · Export · TOC",
    ...
    "toolbar.timelineShow": "Show TOC",
    "toolbar.timelineHide": "Hide TOC",
    ...
    "status.messageHidden": "Message hidden.",
    ...
    "timeline.title": "TOC",
    "timeline.ariaLabel": "Conversation table of contents",
    ...
    "timeline.countAria": "Current node {current}, total messages {total}",
    "timeline.jumpAria": "Jump to message {index}",
    "timeline.previewFallback": "Message {index}",
    "timeline.stubMeta": "Stub",
    "timeline.liveMeta": "Loaded",
    "timeline.renameTitle": "Rename TOC title",
    "timeline.renameShort": "Edit",
    "timeline.hideMessage": "Hide",
    "timeline.expandMessage": "Show",
    "timeline.hideMessageTitle": "Hide this message as a Stub",
    "timeline.expandMessageTitle": "Expand this Stub message",

    "stub.roleUser": "User",
    "stub.roleAssistant": "Assistant",
    "stub.ariaLabel": "Collapsed {role} message {index}",
    "stub.title": "Collapsed message {index}",
    "stub.emptySummary": "No text preview",
    "stub.expand": "Expand",
    "stub.expandAria": "Expand collapsed message {index}",
  ...
  "zh-CN": {
    ...
    "toolbar.timelineShow": "显示目录",
    "toolbar.timelineHide": "隐藏目录",
    "toolbar.settings": "设置",
    ...
    "timeline.title": "目录",
    "timeline.ariaLabel": "对话目录",
    "timeline.hintNoMore": "已经没有消息了",
    "timeline.hintRestore": "请恢复隐藏消息",
    "timeline.hintMessageNotLoaded": "\u8be5\u6d88\u606f\u5f53\u524d\u672a\u6e32\u67d3\uff0c\u8bf7\u6eda\u52a8\u5230\u9644\u8fd1\u52a0\u8f7d\u3002",
    "timeline.countAria": "当前节点 {current}，总消息 {total}",
    "timeline.jumpAria": "跳转到第 {index} 条消息",
    "timeline.previewFallback": "消息 {index}",
    "timeline.stubMeta": "Stub",
    "timeline.liveMeta": "已加载",
    "timeline.renameTitle": "重命名目录标题",
    "timeline.renameShort": "改",
    "timeline.hideMessage": "隐藏",
    "timeline.expandMessage": "展开",
    "timeline.hideMessageTitle": "将这条消息隐藏为 Stub",
    "timeline.expandMessageTitle": "展开这条 Stub 消息",

    "stub.roleUser": "用户",
    "stub.roleAssistant": "助手",
    "stub.ariaLabel": "已虚拟替换的{role}消息 {index}",
    "stub.title": "已虚拟替换消息 {index}",
    "stub.emptySummary": "暂无文本预览",
    "stub.expand": "展开",
    "stub.expandAria": "展开已隐藏消息 {index}",
